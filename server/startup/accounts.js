...
export default function () {
  ...
  Accounts.onCreateUser((options, user) => {
    ...
    const defaultVisitorRole =  ["anonymous", "guest", "product", "tag", "index", "cart/checkout", "cart/completed", "about", "wallet"];
    const defaultRoles =  ["guest", "account/profile", "product", "tag", "index", "cart/checkout", "cart/completed", "about", "wallet"];
    const roles = {};
    const additionals = {
