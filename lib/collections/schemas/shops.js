...
export const Shop = new SimpleSchema({
  ...
  "defaultVisitorRole": {
    type: [String],
    defaultValue: ["anonymous", "guest", "product", "tag", "index", "cart/checkout", "cart/completed", "about"]
  },
  "defaultRoles": {
    type: [String],
    defaultValue: ["guest", "account/profile", "product", "tag", "index", "cart/checkout", "cart/completed", "about"]
  },
  "defaultSellerRoles": {
    type: [String],
    defaultValue: [
