...
/**
 * isDigitalProduct
 * @summary determine whether or not a given product is a digital product
 * @param {Number} productId - the id of the given product
 * @return {Object} currently selected variant object
 */
ReactionProduct.isDigitalProduct = (productId) => {
  return Catalog.isDigitalProduct(productId);
};
