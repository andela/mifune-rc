...
export default Catalog = {
  ...
  /**
   * isDigitalProduct
   * @summary Determine whether this product is digital or not.
   *
   * @param {String|null} productId - The id of this product
   * @return {Boolean} - Returns true if product is digital, and false
   * if otherwise.
   */
